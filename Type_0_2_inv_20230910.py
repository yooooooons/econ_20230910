...
BTC_0_dic = {'type': 'type_0', 'coin_No': 0, 'coin_Name': 'KRW-BTC', 'ma_duration_long': 67, 'ma_duration_mid': 29, 'ma_duration_short': 5, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 5, 'ratio_ema_mid_long': 0.985, 'ref_vol_duration': 1.0, 'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 16, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.004, 'ratio_sell_ema_mid': 0.999, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.03, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

ETH_1_dic = {'type': 'type_0', 'coin_No': 1, 'coin_Name': 'KRW-ETH', 'ma_duration_long': 80, 'ma_duration_mid': 40, 'ma_duration_short': 5,'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 9, 'ratio_ema_mid_long': 0.985, 'ref_vol_duration': 4.0, 'diff_m_l_factor': 0.005, 'coe_vol_comp': 0.5, 'under_long_duration': 15, 'recent_vol_duration': 10, 'sell_method_vol_cri': 1.0, 'ratio_peak_diff': 0.003, 'ratio_sell_ema_mid': 0.0, 'ratio_std_1': 0.0, 'ratio_std_2': 0.0, 'ratio_sell_forced': 0.15, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

WAVES_7_dic = {'type': 'type_0', 'coin_No': 7, 'coin_Name': 'KRW-WAVES', 'ma_duration_long': 95, 'ma_duration_mid': 37, 'ma_duration_short': 1, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 9, 'ratio_ema_mid_long': 0.98, 'ref_vol_duration': 1.0, 'diff_m_l_factor': 0.0, 'coe_vol_comp': 0.5, 'under_long_duration': 15, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.004, 'ratio_sell_ema_mid': 0.999, 'ratio_std_1': 0.1, 'ratio_std_2': 0.03, 'ratio_sell_forced': 0.08, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

STEEM_11_dic = {'type': 'type_0', 'coin_No': 11, 'coin_Name': 'KRW-STEEM', 'ma_duration_long': 70, 'ma_duration_mid': 37, 'ma_duration_short': 7, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0, 'successive_rise': 13, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1.0, 'diff_m_l_factor': 0.005, 'coe_vol_comp': 0.5, 'under_long_duration': 25, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.2, 'ratio_peak_diff': 0.004, 'ratio_sell_ema_mid': 0.0, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.09, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}

HIVE_67_dic = {'type': 'type_0', 'coin_No': 67, 'coin_Name': 'KRW-HIVE', 'ma_duration_long': 72, 'ma_duration_mid': 35, 'ma_duration_short': 2, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0005, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 9, 'ratio_ema_mid_long': 0.99, 'ref_vol_duration': 1.0, 'diff_m_l_factor': 0, 'coe_vol_comp': 1.0, 'under_long_duration': 17, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.004, 'ratio_sell_ema_mid': 0.0, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0, 'bought_time': 0.0}




ETC_5_dic = {'type': 'type_2', 'coin_No': 5, 'coin_Name': 'KRW-ETC', 'ma_duration_long': 102, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 30, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_std_1': 0.2, 'ratio_std_2': 0.1, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 20, 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 32, 'ma_duration_short': 50, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 5, 'ratio_ema_mid_long': 0.985, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 20, 'recent_vol_duration': 10, 'sell_method_vol_cri': 0.8, 'ratio_peak_diff': 0.014, 'interm_sell_duration': 5, 'ratio_std_1': 0.2, 'ratio_std_2': 0.1, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 14, 'coin_Name': 'KRW-ARK', 'ma_duration_long': 91, 'ma_duration_mid': 27, 'ma_duration_short': 63, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 40, 'recent_vol_duration': 12, 'sell_method_vol_cri': 0.6, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 999, 'ratio_std_1': 0.1, 'ratio_std_2': 0.05, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 57, 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 104, 'ma_duration_mid': 23, 'ma_duration_short': 67, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 37, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 5, 'ratio_std_1': 0.15, 'ratio_std_2': 0.07, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 9, 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 77, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 10, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 39, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.4, 'ratio_peak_diff': 0.006, 'interm_sell_duration': 5, 'ratio_std_1': 0.15, 'ratio_std_2': 0.07, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

BCH_30_dic = {'type': 'type_2', 'coin_No': 30, 'coin_Name': 'KRW-BCH', 'ma_duration_long': 103, 'ma_duration_mid': 30, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 49, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.7, 'ratio_peak_diff': 0.005, 'interm_sell_duration': 6, 'ratio_std_1': 0, 'ratio_std_2': 0, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 72, 'coin_Name': 'KRW-BORA', 'ma_duration_long': 101, 'ma_duration_mid': 35, 'ma_duration_short': 61, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'successive_rise': 11, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 5, 'recent_vol_duration': 7, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.007, 'interm_sell_duration': 3, 'ratio_std_1': 0, 'ratio_std_2': 0, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}


# In[9]:


LIST_target = [BTC_0_dic, ETH_1_dic, WAVES_7_dic, STEEM_11_dic, HIVE_67_dic, ETC_5_dic, BTG_20_dic, ARK_14_dic, WAXP_57_dic, QTUM_9_dic, BCH_30_dic, BORA_72_dic]
...
candle_count = round((60/time_unit) * 24 * 200)
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        print('(DF_check[ref_vol_amount][-2] >= target_dic[coe_vol_comp]) and (DF_check[ref_vol_amount][-2] >= DF_check[ref_vol_amount][-3]) and (DF_check[ref_vol_amount][-2] >= DF_check[ref_vol_amount][-4]) _____ {0} > {1} & {2} & {3}'.              format(DF_check['ref_vol_amount'][-2], target_dic['coe_vol_comp'], DF_check['ref_vol_amount'][-3], DF_check['ref_vol_amount'][-4]))
        print('(-DF_check.loc[DF_check.iloc[-(target_dic[under_long_duration] + 1) : -1][diff_m_l].idxmin()][diff_m_l] > (target_dic[diff_m_l_factor] * DF_check[open][-1]) _____ {0} > {1}'.              format(-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'], (target_dic['diff_m_l_factor'] * DF_check['open'][-1])))
                       
        
        if (DF_check['ratio_ema_long'][-4] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and         (DF_check['ratio_ema_long'][-1] > (target_dic['ratio_ema_long_rise'] + target_dic['recent_ratio_ema_long_plus'])) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 2)) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) and         (DF_check['ref_vol_amount'][-2] >= target_dic['coe_vol_comp']) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-3]) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-4]) and         (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        print('((DF_check_peak.loc[DF_check_peak.iloc[-time_elapse_bought : ][ratio_ema_long].idxmax()][ratio_ema_long] - DF_check_peak[ratio_ema_long][-1] >  target_dic[ratio_peak_diff]) ____ {0} > {1}'.                     format((DF_check_peak.loc[DF_check_peak.iloc[-time_elapse_bought : ]['ratio_ema_long'].idxmax()]['ratio_ema_long'] - DF_check_peak['ratio_ema_long'][-1]), target_dic['ratio_peak_diff']))
        ...
        if (time_elapse_bought > 1) and (DF_check_peak['volume'][-2] < (target_dic['sell_method_vol_cri'] * DF_check_peak.iloc[(-5) : -2]['volume'].mean())) and         (((DF_check_peak.loc[DF_check_peak.iloc[-time_elapse_bought : -1]['ratio_ema_long'].idxmax()]['ratio_ema_long'] - DF_check_peak['ratio_ema_long'][-1]) > target_dic['ratio_peak_diff']) or          (DF_check_peak['ratio_ema_mid'][-1] < target_dic['ratio_sell_ema_mid'])) :
        ...
        print('(DF_check_peak.iloc[-11 : -1][high].std() < (target_dic[ratio_std_1] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)][high].std())) _____ {0} < {1}'.              format(DF_check_peak.iloc[-11 : -1]['high'].std(), (target_dic['ratio_std_1'] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)]['high'].std())))
        print('(DF_check_peak.iloc[-6 : -1][high].std() < (target_dic[ratio_std_2] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)][high].std())) _____ {0} < {1}'.              format(DF_check_peak.iloc[-6 : -1]['high'].std(), (target_dic['ratio_std_2'] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)]['high'].std())))
        print('(DF_check_peak[open][-1] < DF_check_peak[open][-2]) and (DF_check_peak[open][-1] < DF_check_peak[open][-4]) (DF_check_peak[open][-1] < DF_check_peak[open][-7]) ___ {0} < {1} / {2} / {3}'.              format(DF_check_peak[open][-1], DF_check_peak[open][-2], DF_check_peak[open][-4], DF_check_peak[open][-7]))
                     
        
        if (time_elapse_bought > 5) and         (DF_check_peak.iloc[-11 : -1]['high'].std() < (target_dic['ratio_std_1'] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)]['high'].std())) and         (DF_check_peak.iloc[-6 : -1]['high'].std() < (target_dic['ratio_std_2'] * DF_check_peak.iloc[-(time_elapse_bought + 5 + 1) : -(time_elapse_bought - 5 + 1)]['high'].std())) and         (DF_check_peak['open'][-1] < DF_check_peak['open'][-2]) and (DF_check_peak['open'][-1] < DF_check_peak['open'][-4]) and (DF_check_peak['open'][-1] < DF_check_peak['open'][-7]) :
...
def type_2_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        print('DF_check[ratio_ema_mid][-1] > criteria _____ {0} > {1}'.format(DF_check['ratio_ema_mid'][-1], target_dic['ratio_ema_mid_rise']))
        print('DF_check.iloc[-(target_dic[successive_rise] + 2) : ][rise_check_short].sum() >= (target_dic[successive_rise] - 0) _____ {0} >= {1}'.              format(DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum(), (target_dic['successive_rise'] - 0)))
        ...
        print('-DF_check.loc[DF_check.iloc[-(target_dic[under_long_duration] + 1) : -1][diff_m_l].idxmin()][diff_m_l] > (target_dic[diff_m_l_factor] * DF_check[open][-1]) _____ {0} > {1}'.              format(-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'], (target_dic['diff_m_l_factor'] * DF_check['open'][-1])))
        print('(DF_check.loc[DF_check.iloc[-6 : -2][recent_vol_aver].idxmax()][recent_vol_aver] - DF_check[recent_vol_aver][-2]) < target_dic[diff_vol_aver]) _____ {0} < {1}'.              format((DF_check.loc[DF_check.iloc[-6 : -2]['recent_vol_aver'].idxmax()]['recent_vol_aver'] - DF_check['recent_vol_aver'][-2]), target_dic['diff_vol_aver']))
        print('(DF_check[ema_mid][-1] / DF_check[ema_long][-1]) > target_dic[ratio_ema_mid_long] _____{0} > {1}'.format((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]), target_dic['ratio_ema_mid_long']))               
        
        if (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-1] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 0)) and         (DF_check['volume'][-2] >= (target_dic['ratio_vol_curr_prior'] * DF_check.iloc[-4 : -2]['volume'].mean())) and         (DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['mid_under_long'].sum() == 0) and (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) and         ((DF_check.loc[DF_check.iloc[-6 : -2]['recent_vol_aver'].idxmax()]['recent_vol_aver'] - DF_check['recent_vol_aver'][-2]) < target_dic['diff_vol_aver']) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        print('Cheking Peak_difference with coin :', target_coin)
        print('(DF_check_peak[volume][-2] < (target_dic[sell_method_vol_cri] * DF_check_peak.iloc[(-5) : -2][volume].mean())) _____ {0} < {1}'.format(DF_check_peak['volume'][-2], (target_dic['sell_method_vol_cri'] * DF_check_peak.iloc[(-5) : -2]['volume'].mean())))
        print('((DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1][ratio_ema_short].idxmax()][ratio_ema_short] - DF_check_peak[ratio_ema_short][-1]) >  target_dic[ratio_peak_diff]) ____ {0} > {1}'.               format((DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['ratio_ema_short'].idxmax()]['ratio_ema_short'] - DF_check_peak['ratio_ema_short'][-1]), target_dic['ratio_peak_diff']))
        ...
        print('Cheking Falling_trend with coin :', target_coin)
        print('(DF_check_peak[open][-1] < target_dic[bought_price]) ___ {0} < {1}'.fotmat((DF_check_peak['open'][-1], target_dic['bought_price'])))
        print('(DF_check_peak.iloc[-target_dic[interm_sell_duration] : ][bought_rise_fall].sum() < time_auto_interm_sell_duration) ___ {0} < {1}'.format(DF_check_peak.iloc[-target_dic['interm_sell_duration'] : ]['bought_rise_fall'].sum(), time_auto_interm_sell_duration))
        print('(DF_check_peak.iloc[-(target_dic[interm_sell_duration] + 1) : -1][volume].mean() < (1.0 * DF_check_peak.iloc[-(time_elapse_bought + 1) : -1][volume].mean())) ___ {0} < {1}'.              format(DF_check_peak.iloc[-(target_dic['interm_sell_duration'] + 1) : -1]['volume'].mean(), (1.0 * DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['volume'].mean())))
        print('(DF_check_peak[open][-1] / DF_check_peak[open][-(target_dic[interm_sell_duration] + 1)]) < (1 - (0.6 * target_dic[ratio_sell_forced])) ___ {0} < {1}'.              format((DF_check_peak['open'][-1] / DF_check_peak['open'][-(target_dic['interm_sell_duration'] + 1)]), (1 - (0.6 * target_dic['ratio_sell_forced']))))        
        
        
        if (DF_check_peak['open'][-1] < target_dic['bought_price']) and         (DF_check_peak.iloc[-target_dic['interm_sell_duration'] : ]['bought_rise_fall'].sum() < time_auto_interm_sell_duration) and         (DF_check_peak.iloc[-(target_dic['interm_sell_duration'] + 1) : -1]['volume'].mean() < (1.0 * DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['volume'].mean())) and         ((DF_check_peak['open'][-1] / DF_check_peak['open'][-(target_dic['interm_sell_duration'] + 1)]) < (1 - (0.6 * target_dic['ratio_sell_forced']))) :
            
            transaction_sell = upbit.sell_market_order(target_coin, get_balance(target_coin[4:]))  # 시장가에 매도
            time.sleep(5)
            print('\nnow :', (datetime.datetime.now() + datetime.timedelta(seconds=(time_factor * 3600))))
            print('sell_transaction_result_by_Falling_trend :', transaction_sell)
        ...
        if (0 < (now.minute % time_unit) <= 5) & (0 < (now.second % 60) <= 59):  # N시:01:00초 ~ N시:01:59초 사이 시각이면
            ...
            for i in range(0, len(LIST_target), 1):
                if LIST_target[i]['type'] == 'type_0' :
                    ...
                    buy_sell_checkl = type_2_buy_sell_normal (LIST_target[i])
